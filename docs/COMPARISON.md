...
[![v1.1.6](https://img.shields.io/badge/version-1.1.6-7c3aed?style=for-the-badge)](../package.json)
...
| Dimension | **GHCP-MEM v1.1.6** | PluresLM | Remember-MCP | Cortex-Memory | Cortex (Claude) | claude-mem v13.x |
|---|---|---|---|---|---|---|
...
<sub>**Comparison for GHCP-MEM v1.1.6** · last refreshed May 2026</sub>
