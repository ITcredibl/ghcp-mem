...
[![v1.18.1](https://img.shields.io/badge/version-1.18.1-7c3aed?style=for-the-badge)](../package.json)
...
| Dimension | **GHCP-MEM v1.18.1** | **GitHub Copilot Memory** (public preview) |
|---|---|---|
...
| Dimension | **GHCP-MEM v1.18.1** | PluresLM | Remember-MCP | Cortex-Memory | Cortex (Claude) | claude-mem v13.x |
|---|---|---|---|---|---|---|
...
<sub>**Comparison for GHCP-MEM v1.18.1** · last refreshed September 2026</sub>
